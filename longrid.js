  ...
  const cards = [
    {
      ...
      title: 'Уолл-стрит 🐺',
      chunks: [
        'Boss: Сколько наша компания заработает в следующем месяце?',
        'Billy: Чем больше, тем лучше! Работаем!',
        'Boss: Мне не мотивация нужна. Цифры.',
        'Billy: Не знаю. Много.',
    ...
    },
    {
      ...
      chunks: [
        'Jeremy: Мой план это 15 этапов 🤯. Не пугайтесь, Босс, нажмите далее и легко разберётесь с каждым шагом:',
    ...
    {
      id: 'class_imbalance',
      title: '6. Обработка дисбаланса классов 👽',
      chunks: [
