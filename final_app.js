(function(){
  ...
  const steps = [
    { id:'final_q1', title:'Скорость просмотра', text:'Ты смотришь видео. Твоя любимая скорость просмотра — это…', choices:['0.75x','1x','1.25x','1.5x','2x'] },
    { id:'final_q2', title:'Ламборгини', text:'Ты в гараже с новой Ламборгини. Что ты сделаешь?', choices:['Сфоткаюсь','Прокачу друга','Проедусь на трек','Оставлю в гараже'] },
    { id:'final_q3', title:'Почему ML', text:'Почему ты хочешь учиться ML?', choices:['Карьерный рост','Интересно','Деньги','Стартап'] }
  ];
