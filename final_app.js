...
const quizData = [
  {
    ...
    options: [
      {
        answer: 'а) x1.25 | x1.5 | x2',
        description: "Мой мозг может усваивать информацию быстрее, а лекторы любят говорить банальные вещи."
      },
      {
        answer: 'б) Обычная скорость',
        description: "Люблю вникать в детали, даже если это медленнее."
      },
      {
        answer: 'в) Меня должно зацепить с первых секунд.',
        description: "Если этого не произошло, то дальше неинтересно."
      },
    ],
    scores: { 'а': 3, 'б': 2, 'в': 1 }
  },
  {
    type: 'choice',
    title: 'Вопрос 2: Ты в гараже с новой Lamborghini и у тебя набор инструментов.Что делаешь в первую очередь?',
    options: [
      {
        answer: 'а) Начну с функций на панели в салоне.',
        description: "Поразмышляю как это могло быть построено.  Затем, полезу под капот и буду ковыряться, чтобы изучить каждую деталь по отдельности (анализ) и иметь полное представление о всей системе (синтез)."
      },
      {
        answer: 'б) Открою капот, увижу, что там много всего.',
        description: "Начну откручивать, начнёт получаться, потом случайно могу отвлечься и забыть что за чем идёт.На этом хватит, дальше нет смысла пытаться, положу на место, лучше посижу в салоне."
      },
      {
        answer: 'в) Я под капот лезть не собираюсь.',
        description: "А вдруг я там сломаю что-нибудь. Что мне голову забивать как работает машина?Похожу по гаражу, посчитаю количество шагов."
      },
    ],
    scores: { 'а': 3, 'б': 2, 'в': 1 }
  },
  {
    ...
    options: [
      {
        answer: 'а) Мне ИНТЕРЕСНО, как это работает.',
        description: "Хочу понимать в чём идея, освоить новые инструменты, развивать свой интеллект.Если там реально круто, то продолжить изучать и стать выдающимся профессионалом через несколько лет."
      },
      {
        answer: 'б) Это перспективно и за это хорошо платят.',
        description: "НАДО осваивать новые навыки, чтобы быть в теме.Плюс, зп хочу побольше, а в IT вроде платят."
      },
      {
        answer: 'в) Я потерян.',
        description: "Я вроде хочу что-то изучать, но не знаю что.Хочу кому-то заплатить, чтобы получить ощущение, что я начал принимать smart решения, а там меня за ручку доведут до денег."
      },
    ],
    scores: { 'а': 3, 'б': 2, 'в': 1 }
  }
...
function getVerdict(score) {
  if (score >= 7 && score <= 9) {
    return {
      ...
      subtitle: 'Ты с очень большой вероятностью сможешь освоить курс.<br>Мы очень рады, что встретили такого человека!',
      content: `
        <p><strong>Твой портрет:</strong> Ты любознателен до глубины души. Не потому что «надо», а потому что <strong>интересно</strong>. Ты пытаешься понять суть глубоко, а твой мозг требует скорости и эффективности. Ты смотришь в долгосрочную перспективу — стать профессионалом!».</p>
        <p><strong>Почему курс тебе подходит:</strong> Курс — это ключ к миру, который ты хочешь понять. Ты будешь не «проходить» уроки, а погружаться в них, задавать вопросы и получать удовольствие от того, как складывается общая картина. Ты — идеальный студент.</p>
      `
    };
    ...
    return {
      ...
      content: `
        <p><strong>Твой портрет:</strong> Ты прагматичен и амбициозен. Деньги и карьера — сильные мотиваторы. Ты готов браться за сложное, но твой энтузиазм может угаснуть, если результат не приходит быстро. Ты можешь начать разбираться, но можешь отступить, столкнувшись с трудностями.</p>
